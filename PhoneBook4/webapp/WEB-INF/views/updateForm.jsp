...
<body>
	...
	<form action="/PhoneBook4/update" method="get">
		...
		이 름 : <input type="text" name="name" value="${personVo.name }"><br>
		전화번호 : <input type="text" name="hp" value="${personVo.hp }"><br>
		회사번호 : <input type="text" name="company" value="${personVo.company }"><br><br>
