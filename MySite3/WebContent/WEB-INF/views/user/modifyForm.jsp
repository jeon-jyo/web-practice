					...
					<div id="modifyForm">
						<form action="/MySite3/user" method="get">
							...
							<div class="form-group">
								...
								<%-- <input type="radio" id="rdo-male" name="gender" value="male" <%=isFemale ? "" : "checked"%>> --%>
								<%-- <input type="radio" id="rdo-male" name="gender" value="male" <c:if test="${isFemale eq 'false' }">checked</c:if>> --%>
								<input type="radio" id="rdo-male" name="gender" value="male" ${isFemale ? "" : 'checked' }>
								
								<label for="rdo-female">여</label> 
								<%-- <input type="radio" id="rdo-female" name="gender" value="female" <%=isFemale ? "checked" : ""%>> --%>
								<%-- <input type="radio" id="rdo-female" name="gender" value="female" <c:if test="${isFemale eq 'true' }">checked</c:if>> --%>
								<input type="radio" id="rdo-female" name="gender" value="female" ${isFemale ? 'checked' : "" }>
							</div>
